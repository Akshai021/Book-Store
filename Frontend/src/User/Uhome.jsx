...
const Uhome = () => {
 ...
 navigate('/uproducts')
  ...
  <Card style={{ width: '18rem' ,marginRight:"80px",marginLeft:"250px"}}>
  <Link to='/uproducts'>
  ...
  <br/>
  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
  <Card style={{ width: '18rem' ,marginRight:"80px",marginLeft:"650px"}}>
  <Link to='/uproducts'>
  ...
  <Card style={{ width: '18rem',marginRight:"80px"}}>
  <Link to='/uproducts'>
    <Card.Img variant="top" src="https://m.media-amazon.com/images/I/81keZ6LpNWL._SY522_.jpg" />
    </Link>
    <Card.Body>
